...
<body>
    ...
    <div class="containter d-flex justify-content-center">
        <div class="col-md-4 col-md-offset-4">
            <br />
            <ul class="list-group">
                <a href="<?php echo BASE_URL . '/admin/tables/tavolo.php' ?>" class="list-group-item">Tavoli</a>
                <a href="<?php echo BASE_URL . '/admin/tables/prenotazione.php' ?>" class="list-group-item">Prenotazioni</a>
                <a href="<?php echo BASE_URL . '/admin/tables/comanda.php' ?>" class="list-group-item">Comanda</a>
            </ul>
        </div>
    </div>
