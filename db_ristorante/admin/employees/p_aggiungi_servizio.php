...
<body>
    ...
    <div class="container p-4 w-50">
        ...
        <h5><small class="text-muted">Compila il form con le informazioni richieste per aggiungere un cameriere ai dipendenti</small></h5>
        <form action="../../includes/logic/hold.php" method="post">
            ...
            <button type="submit" name="bt_conf_add_srv" class="btn btn-primary mt-2">Conferma</button>
        </form>
    </div>
