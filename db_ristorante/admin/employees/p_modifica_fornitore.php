...
<body>
    ...
    <div class="container p-4 w-50">
        ...
        <h5><small class="text-muted">Compila il form per modificare le informazioni del fornitore</small></h5>
        <form action="../../includes/logic/hold.php" method="post">
            ...
            <button type="submit" name="bt_conf_mod_for" class="btn btn-primary mt-2">Conferma</button>
        </form>
    </div>
