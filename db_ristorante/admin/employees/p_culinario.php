...
<body>
    ...
    <div class="container p-4">
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo '
                            ...
                            <form action="../../includes/logic/hold.php" method="post">
                                <td>
                                <button title="Modifica" type="submit" class="btn btn-primary p-2" value="' . $row["id_culinario"] . '" name="bt_mod_cul"><i class="fas fa-edit"></i></button>
                                <button title="Elimina" type="submit" class="btn btn-danger p-2" value="' . $row["id_culinario"] . '" name="bt_del_cul"><i class="fas fa-trash-alt"></i></button>
                                </td>
                            </form>
                            </tr>
                            ';
        ...
        <form action="../../includes/logic/hold.php" method="post">
            <button type="submit" name="bt_add_cul" class="btn btn-success"><i class="fas fa-plus"></i> Aggiungi</button>
        </form>
    </div>
